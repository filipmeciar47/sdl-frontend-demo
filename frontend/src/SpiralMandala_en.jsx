...
export const SPIRAL_LEVEL_MEANINGS = {
  beige:     'Instinct · Survival',
  purple:    'Tribe · Magic',
  red:       'Power · Ego',
  blue:      'Order · Truth',
  orange:    'Success · Strategy',
  green:     'Community · Plurality',
  yellow:    'Integration · System',
  turquoise: 'Holos · Planetary',
};
...
export default function SpiralMandala({
  ...
  const hintText = mode === 'integrative'
    ? 'Click a layer to open it together with all inner levels'
    : 'Click to add / remove a level; each one keeps glowing in its own color';
